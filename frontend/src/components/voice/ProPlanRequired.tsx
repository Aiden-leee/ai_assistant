            ...
            <div className="max-w-7xl mx-auto px-6 py-8 pt-24">
                    ...
                    <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-background rounded-3xl p-8 border border-primary/20">
                        <div className="relative z-10 flex items-center justify-between">
                            <div className="space-y-4">
                                ...
                                <div>
                                    <h1 className="text-4xl font-bold mb-2">음성 지원 액세스 필요</h1>
                                    <p className="text-muted-foreground">
                                        AI Pro 또는 AI Basic으로 업그레이드하여 AI 치과 조수와의 무제한 음성 상담을 이용하세요
                                    </p>
                                </div>
                            </div>
                ...
                <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30 max-w-2xl mx-auto">
                    <CardContent className="relative p-8 text-center">
                        ...
                        <h3 className="text-2xl font-bold mb-4">업그레이드 필요</h3>
                        <p className="text-muted-foreground mb-6">
                            음성 비서 기능은 AI Pro 및 AI Basic 구독자에게 제공됩니다. <br />
                            자연스러운 음성 대화를 통해 치과 관련 조언을 바로 받아보세요.
                        </p>

                        <div className="space-y-4 mb-6">
                            <div className="flex items-center gap-3 justify-center">
                                <div className="w-2 h-2 bg-primary rounded-full"></div>
                                <span className="text-sm">24시간 연중무휴 음성 상담</span>
                            </div>
                            <div className="flex items-center gap-3 justify-center">
                                <div className="w-2 h-2 bg-primary rounded-full"></div>
